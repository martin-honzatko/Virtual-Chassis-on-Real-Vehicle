...
//     *=======================================*/
//    public const string LOCAL_LOG_FILE = "ChassisSend.log"; //LOG file name.
//    /*=====================================
...
//        catch (Exception ex)
//        {
//            Debug.Log($"PolohaSend LOG exists error : {Application.persistentDataPath} /chassischassisSend.log \n {ex.Message}");
//        }
//    }
//}
